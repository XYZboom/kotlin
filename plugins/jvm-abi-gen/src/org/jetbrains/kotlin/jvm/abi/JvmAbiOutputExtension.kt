...
class JvmAbiOutputExtension(
    ...
    private val doNotSortMembers: Boolean,
    ...
    override fun finalizeClassFactory(factory: ClassFileFactory) {
        ...
        val outputFiles =
            AbiOutputFiles(abiClassInfos, factory, removeDebugInfo, removeDataClassCopyIfConstructorIsPrivate, doNotSortMembers)
                    ...
                    abiInfo is AbiClassInfo.Public ->
                        ...
                        ClassReader(outputFile.asByteArray()).accept(object : ClassVisitor(Opcodes.API_VERSION, remapper) {
                            ...
                            override fun visitAnnotation(descriptor: String?, visible: Boolean): AnnotationVisitor? {
                                ...
                                return abiMetadataProcessor(delegate, removeCopyAlongWithConstructor, doNotSortMembers)
                            }
                            ...
                            override fun visitEnd() {
                                ...
                                keptFields
                                    .apply { if (!doNotSortMembers) sortWith(compareBy(FieldNode::name, FieldNode::desc)) }
                                    .forEach { it.accept(cv) }

                                keptMethods
                                    .apply { if (!doNotSortMembers) sortWith(compareBy(MethodNode::name, MethodNode::desc)) }
                                    .forEach { it.accept(cv) }
