...
class BirVarargLowering : BirLoweringPhase() {
    private val functionAccessExpressions = registerIndexKey(BirFunctionAccessExpression, false)
    private val varargs = registerIndexKey(BirVararg, false)

    override fun lower(module: BirModuleFragment) {
        for (expression in getAllElementsOfClass(functionAccessExpressions)) {
        ...
        for (vararg in getAllElementsOfClass(varargs)) {
