...
abstract class BirLoweringPhase : BirPhase {
     ...
     * perform other heavy checks manually, on elements returned by [getAllElementsOfClass].
     *
     ...
     *
     * @return Token which may be passed to [getAllElementsOfClass].
     *
     * @see getAllElementsOfClass
     */
     ...
     */
    protected fun <E : BirElement> getAllElementsOfClass(key: BirElementsIndexKey<E>): Sequence<E> {
